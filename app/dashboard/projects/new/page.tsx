...
export default function NewProjectPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const errorMessage =
        error instanceof Error ? error.message : "Error al crear el proyecto. Por favor intenta nuevamente.";
  ...
  return (
    <div>
      <div className="mb-6">
        ...
        <p className="text-gray-500">Completa el formulario para solicitar un nuevo proyecto de diseño</p>
      </div>
      ...
      <Card>
        <form onSubmit={handleSubmit}>
          <CardHeader>
            ...
            <CardDescription>
              Proporciona un título claro y una descripción detallada para ayudar a nuestros diseñadores a entender tus
              necesidades.
            </CardDescription>
          </CardHeader>
